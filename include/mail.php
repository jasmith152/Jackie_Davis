...
$yourEmail = "bobjackiedavis@gmail.com"; // the email address you wish to receive these mails through
$yourWebsite = ""; // the name of your website
$thanksPage = ''; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
$maxPoints = 4; // max points a person can hit before it refuses to submit - recommend 4
$requiredFields = "First_Name,Last_Name,email,answer"; // names of the fields you'd like to be required as a minimum, separate each field with a comma
$subject = "Automatic Form Email from ";  // subject of the email from sent to your email
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if (strtolower($_POST['answer']) !== "green") 
